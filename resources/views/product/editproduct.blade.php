    ...
    <div class="row">
        <div class="col">
            @if(Session::has('success'))
                <div class="alert alert-success text-center" style="position: static;">{{ Session::get('success') }}</div>
            @endif
        </div>
    </div>
    ...
    <div class="row">
        <div class="col-sm-6">
            ...
            <form action="{{ route('products.update', $products->id) }}" method="POST">
                ...
                <div class="row">
                    <div class="col-sm-6">
                        <input type="text" class="form-control mb-3" placeholder="Product Name" name="name"
                               value="{{$products->name}}" required autofocus>
                    </div>
                </div>

                <div class="row">
                    <div class="col-sm-6">
                        <input type="text" class="form-control mb-3" placeholder="Product Price" name="price"
                ...
                <div class="row">
                    <div class="col-sm-6">
                        <input type="text" class="form-control mb-3" placeholder="Product Remarks" name="remarks"
                               value="{{$products->remarks}}" required>
                    </div>
                </div>
                <div class="row">
                    <div class="col-sm-6">
